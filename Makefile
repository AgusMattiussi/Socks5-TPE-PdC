CC=gcc
CCFLAGS_FINAL=-g -Wall -Wextra -fsanitize=address -Wno-unused-parameter -Wno-implicit-fallthrough -pedantic -pedantic-errors -std=c11 -D_POSIX_C_SOURCE=200112L -pthread
# -fsanitize=address
